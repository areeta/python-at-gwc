...
#Write a function that draws a square by using the code you used to draw a square using for loops. Call your function to make sure it draws the exact same square!
#Write a functions that draws a triangle using the code you used to draw  triangle using a for loop. Call it to test that it works!
